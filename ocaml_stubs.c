...
/* caml_frametable is defined in frametables.S with all module frametables */

/* Global roots for major GC scanning
 * Each entry must point to a <module>.gc_roots symbol, NOT the module data!
 * The gc_roots is a null-terminated list of block pointers to scan.
...
/* Exception stubs */
value caml_exn_Failure = 1;
value caml_exn_Invalid_argument = 1;
value caml_exn_Out_of_memory = 1;
value caml_exn_Stack_overflow = 1;
value caml_exn_Sys_error = 1;
value caml_exn_End_of_file = 1;
value caml_exn_Division_by_zero = 1;
value caml_exn_Not_found = 1;
value caml_exn_Sys_blocked_io = 1;
value caml_exn_Match_failure = 1;
value caml_exn_Assert_failure = 1;
value caml_exn_Undefined_recursive_module = 1;

/* Apply functions - now provided by curry_functions.o */
/* caml_apply2/3 should come from curry_functions.o in libstdlib_pico.a */
...
/* Code segments - OCaml generated code symbols */
extern char camlHello_code_begin __asm__("camlHello.code_begin");
extern char camlHello_code_end __asm__("camlHello.code_end");
struct segment { char *begin; char *end; };
struct segment caml_code_segments[] = {
    { &camlHello_code_begin, &camlHello_code_end },
    { NULL, NULL }
};

/* Stdlib module entry functions - must be called in dependency order! */
extern void camlCamlinternalFormatBasics_entry(void) __asm__("camlCamlinternalFormatBasics.entry");
extern void camlStdlib_entry(void) __asm__("camlStdlib.entry");
extern void camlStdlib__Either_entry(void) __asm__("camlStdlib__Either.entry");
extern void camlStdlib__Sys_entry(void) __asm__("camlStdlib__Sys.entry");
extern void camlStdlib__Obj_entry(void) __asm__("camlStdlib__Obj.entry");
extern void camlStdlib__Type_entry(void) __asm__("camlStdlib__Type.entry");
extern void camlStdlib__Atomic_entry(void) __asm__("camlStdlib__Atomic.entry");
extern void camlCamlinternalLazy_entry(void) __asm__("camlCamlinternalLazy.entry");
extern void camlStdlib__Lazy_entry(void) __asm__("camlStdlib__Lazy.entry");
extern void camlStdlib__Seq_entry(void) __asm__("camlStdlib__Seq.entry");
extern void camlStdlib__Option_entry(void) __asm__("camlStdlib__Option.entry");
extern void camlStdlib__Pair_entry(void) __asm__("camlStdlib__Pair.entry");
extern void camlStdlib__Result_entry(void) __asm__("camlStdlib__Result.entry");
extern void camlStdlib__Bool_entry(void) __asm__("camlStdlib__Bool.entry");
extern void camlStdlib__Char_entry(void) __asm__("camlStdlib__Char.entry");
extern void camlStdlib__Uchar_entry(void) __asm__("camlStdlib__Uchar.entry");
extern void camlStdlib__List_entry(void) __asm__("camlStdlib__List.entry");
extern void camlStdlib__Int_entry(void) __asm__("camlStdlib__Int.entry");
extern void camlStdlib__Array_entry(void) __asm__("camlStdlib__Array.entry");
extern void camlStdlib__Iarray_entry(void) __asm__("camlStdlib__Iarray.entry");
extern void camlStdlib__Bytes_entry(void) __asm__("camlStdlib__Bytes.entry");
extern void camlStdlib__String_entry(void) __asm__("camlStdlib__String.entry");
extern void camlStdlib__Unit_entry(void) __asm__("camlStdlib__Unit.entry");
extern void camlStdlib__Marshal_entry(void) __asm__("camlStdlib__Marshal.entry");
extern void camlStdlib__Float_entry(void) __asm__("camlStdlib__Float.entry");
extern void camlStdlib__Int32_entry(void) __asm__("camlStdlib__Int32.entry");
extern void camlStdlib__Int64_entry(void) __asm__("camlStdlib__Int64.entry");
extern void camlStdlib__Nativeint_entry(void) __asm__("camlStdlib__Nativeint.entry");
extern void camlStdlib__Lexing_entry(void) __asm__("camlStdlib__Lexing.entry");
extern void camlStdlib__Parsing_entry(void) __asm__("camlStdlib__Parsing.entry");
extern void camlStdlib__Repr_entry(void) __asm__("camlStdlib__Repr.entry");
extern void camlStdlib__Set_entry(void) __asm__("camlStdlib__Set.entry");
extern void camlStdlib__Map_entry(void) __asm__("camlStdlib__Map.entry");
extern void camlStdlib__Stack_entry(void) __asm__("camlStdlib__Stack.entry");
extern void camlStdlib__Queue_entry(void) __asm__("camlStdlib__Queue.entry");
extern void camlStdlib__Buffer_entry(void) __asm__("camlStdlib__Buffer.entry");
extern void camlStdlib__Mutex_entry(void) __asm__("camlStdlib__Mutex.entry");
extern void camlStdlib__Condition_entry(void) __asm__("camlStdlib__Condition.entry");
extern void camlStdlib__Semaphore_entry(void) __asm__("camlStdlib__Semaphore.entry");
extern void camlCamlinternalFormat_entry(void) __asm__("camlCamlinternalFormat.entry");
extern void camlStdlib__Printf_entry(void) __asm__("camlStdlib__Printf.entry");
extern void camlStdlib__Arg_entry(void) __asm__("camlStdlib__Arg.entry");
extern void camlStdlib__Printexc_entry(void) __asm__("camlStdlib__Printexc.entry");
extern void camlStdlib__Domain_entry(void) __asm__("camlStdlib__Domain.entry");
extern void camlStdlib__Fun_entry(void) __asm__("camlStdlib__Fun.entry");
extern void camlStdlib__Gc_entry(void) __asm__("camlStdlib__Gc.entry");
extern void camlStdlib__In_channel_entry(void) __asm__("camlStdlib__In_channel.entry");
extern void camlStdlib__Out_channel_entry(void) __asm__("camlStdlib__Out_channel.entry");
extern void camlStdlib__Digest_entry(void) __asm__("camlStdlib__Digest.entry");
extern void camlStdlib__Bigarray_entry(void) __asm__("camlStdlib__Bigarray.entry");
extern void camlStdlib__Random_entry(void) __asm__("camlStdlib__Random.entry");
extern void camlStdlib__Hashtbl_entry(void) __asm__("camlStdlib__Hashtbl.entry");
extern void camlStdlib__Weak_entry(void) __asm__("camlStdlib__Weak.entry");
extern void camlStdlib__Format_entry(void) __asm__("camlStdlib__Format.entry");
extern void camlStdlib__Scanf_entry(void) __asm__("camlStdlib__Scanf.entry");
extern void camlStdlib__Callback_entry(void) __asm__("camlStdlib__Callback.entry");
extern void camlCamlinternalOO_entry(void) __asm__("camlCamlinternalOO.entry");
extern void camlStdlib__Oo_entry(void) __asm__("camlStdlib__Oo.entry");
extern void camlCamlinternalMod_entry(void) __asm__("camlCamlinternalMod.entry");
extern void camlStdlib__Dynarray_entry(void) __asm__("camlStdlib__Dynarray.entry");
extern void camlStdlib__Pqueue_entry(void) __asm__("camlStdlib__Pqueue.entry");
extern void camlStdlib__Ephemeron_entry(void) __asm__("camlStdlib__Ephemeron.entry");
extern void camlStdlib__Filename_entry(void) __asm__("camlStdlib__Filename.entry");
extern void camlStdlib__Complex_entry(void) __asm__("camlStdlib__Complex.entry");
extern void camlStdlib__ArrayLabels_entry(void) __asm__("camlStdlib__ArrayLabels.entry");
extern void camlStdlib__ListLabels_entry(void) __asm__("camlStdlib__ListLabels.entry");
extern void camlStdlib__BytesLabels_entry(void) __asm__("camlStdlib__BytesLabels.entry");
extern void camlStdlib__StringLabels_entry(void) __asm__("camlStdlib__StringLabels.entry");
...
void caml_program(void) {
    /* Only essential modules in dependency order */
    camlCamlinternalFormatBasics_entry();
    camlStdlib_entry();
    camlStdlib__Either_entry();
    camlStdlib__Sys_entry();
    camlStdlib__Obj_entry();
    camlStdlib__Type_entry();
    camlStdlib__Atomic_entry();
    camlCamlinternalLazy_entry();
    camlStdlib__Lazy_entry();
    camlStdlib__Seq_entry();
    camlStdlib__Option_entry();
    camlStdlib__Pair_entry();
    camlStdlib__Result_entry();
    camlStdlib__Bool_entry();
    camlStdlib__Char_entry();
    camlStdlib__Uchar_entry();
    camlStdlib__List_entry();
    camlStdlib__Int_entry();
    camlStdlib__Array_entry();
    camlStdlib__Bytes_entry();
    camlStdlib__String_entry();
    camlStdlib__Unit_entry();
